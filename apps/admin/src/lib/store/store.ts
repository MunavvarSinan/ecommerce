            ...
            updateUserProfile: (profile) => {
                set((state) => ({
                    user: {
                        ...
                        role: profile.role !== undefined ? profile.role : state.user?.role || '',
                        email: profile.email !== undefined ? profile.email : state.user?.email || '',
                        token: profile.token !== undefined ? profile.token : state.user?.token || '',
